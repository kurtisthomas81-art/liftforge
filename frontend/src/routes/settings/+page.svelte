...
{#if landmarks.length > 0}
  <div class="settings-section">
    ...
    <p class="section-desc">Sets per week targets — edit to match your recovery. <span class="landmark-legend"><Term t="mev" /> (floor) · <Term t="mav" /> (target zone) · <Term t="mrv" /> (limit)</span></p>
      ...
      <table class="landmarks-table">
        <thead>
          <tr>
            <th>Muscle</th>
            <th><Term t="mev" /></th>
            <th><Term t="mav" /> Low</th>
            <th><Term t="mav" /> High</th>
            <th><Term t="mrv" /></th>
          </tr>
        </thead>
        <tbody>
